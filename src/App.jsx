...
const TEAMS_MENS = [
  ...
  { id: 9, name: "Arizona", seed: 1, region: "West" },
  { id: 10, name: "Iowa State", seed: 2, region: "West" },
  { id: 11, name: "Illinois", seed: 3, region: "West" },
  { id: 12, name: "Alabama", seed: 4, region: "West" },
  { id: 13, name: "Wisconsin", seed: 5, region: "West" },
  { id: 14, name: "North Carolina", seed: 6, region: "West" },
  { id: 15, name: "Saint Mary's", seed: 7, region: "West" },
  { id: 16, name: "Villanova", seed: 8, region: "West" },
  // SOUTH (Florida's region)
  { id: 17, name: "Florida", seed: 1, region: "South" },
  { id: 18, name: "Houston", seed: 2, region: "South" },
  { id: 19, name: "Gonzaga", seed: 3, region: "South" },
  { id: 20, name: "Arkansas", seed: 4, region: "South" },
  { id: 21, name: "Vanderbilt", seed: 5, region: "South" },
  { id: 22, name: "Tennessee", seed: 6, region: "South" },
  { id: 23, name: "Miami (Fla.)", seed: 7, region: "South" },
  { id: 24, name: "Clemson", seed: 8, region: "South" },
  // MIDWEST (Michigan's region)
  { id: 25, name: "Michigan", seed: 1, region: "Midwest" },
  { id: 26, name: "Purdue", seed: 2, region: "Midwest" },
  { id: 27, name: "Virginia", seed: 3, region: "Midwest" },
  { id: 28, name: "Nebraska", seed: 4, region: "Midwest" },
  { id: 29, name: "Texas Tech", seed: 5, region: "Midwest" },
  { id: 30, name: "BYU", seed: 6, region: "Midwest" },
  { id: 31, name: "Kentucky", seed: 7, region: "Midwest" },
  { id: 32, name: "Georgia", seed: 8, region: "Midwest" },
];
