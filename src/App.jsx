...
const lb = (profiles || []).map(p => ({
        ...
        round3_points: p.round3_points || 0,
        round4_points: p.round4_points || 0,
        round5_points: p.round5_points || 0,
      }));
      setLeaderboard(lb);
    } catch { }
  };
...
const scoredLeaderboard = leaderboard
    .map(p => {
      const pastPoints = (p.round1_points || 0) + (p.round2_points || 0) + (p.round3_points || 0) + (p.round4_points || 0) + (p.round5_points || 0);
      let currentPoints = 0;
