...
const TEAMS_MENS = [
  ...
  { id: 12, name: "UNI", seed: 12, region: "East" },
  { id: 13, name: "Cal Baptist", seed: 13, region: "East" },
  { id: 14, name: "North Dakota State", seed: 14, region: "East" },
  { id: 15, name: "Queens", seed: 15, region: "East" },
  { id: 16, name: "Siena", seed: 16, region: "East" },
  // WEST
  { id: 17, name: "Arizona", seed: 1, region: "West" },
  { id: 18, name: "Iowa State", seed: 2, region: "West" },
  { id: 19, name: "Illinois", seed: 3, region: "West" },
  { id: 20, name: "Alabama", seed: 4, region: "West" },
  { id: 21, name: "Wisconsin", seed: 5, region: "West" },
  { id: 22, name: "North Carolina", seed: 6, region: "West" },
  { id: 23, name: "Saint Mary's", seed: 7, region: "West" },
  { id: 24, name: "Villanova", seed: 8, region: "West" },
  { id: 25, name: "Utah State", seed: 9, region: "West" },
  { id: 26, name: "Texas A&M", seed: 10, region: "West" },
  { id: 27, name: "VCU", seed: 11, region: "West" },
  { id: 28, name: "High Point", seed: 12, region: "West" },
  { id: 29, name: "Hofstra", seed: 13, region: "West" },
  { id: 30, name: "Penn", seed: 14, region: "West" },
  { id: 31, name: "Tennessee State", seed: 15, region: "West" },
  ...
  { id: 35, name: "Gonzaga", seed: 3, region: "South" },
  { id: 36, name: "Arkansas", seed: 4, region: "South" },
  { id: 37, name: "Vanderbilt", seed: 5, region: "South" },
  { id: 38, name: "Tennessee", seed: 6, region: "South" },
  { id: 39, name: "Miami (Fla.)", seed: 7, region: "South" },
  { id: 40, name: "Clemson", seed: 8, region: "South" },
  { id: 41, name: "Iowa", seed: 9, region: "South" },
  { id: 42, name: "Missouri", seed: 10, region: "South" },
  { id: 43, name: "NC State", seed: 11, region: "South" },
  { id: 44, name: "Akron", seed: 12, region: "South" },
  { id: 45, name: "Troy", seed: 13, region: "South" },
  { id: 46, name: "Kennesaw State", seed: 14, region: "South" },
  { id: 47, name: "Furman", seed: 15, region: "South" },
  { id: 48, name: "Idaho", seed: 16, region: "South" },
  // MIDWEST
  { id: 49, name: "Michigan", seed: 1, region: "Midwest" },
  { id: 50, name: "Purdue", seed: 2, region: "Midwest" },
  { id: 51, name: "Virginia", seed: 3, region: "Midwest" },
  { id: 52, name: "Nebraska", seed: 4, region: "Midwest" },
  { id: 53, name: "Texas Tech", seed: 5, region: "Midwest" },
  { id: 54, name: "BYU", seed: 6, region: "Midwest" },
  ...
  { id: 59, name: "NC State", seed: 11, region: "Midwest" },
  { id: 60, name: "McNeese", seed: 12, region: "Midwest" },
  { id: 61, name: "Hawai'i", seed: 13, region: "Midwest" },
  { id: 62, name: "Wright State", seed: 14, region: "Midwest" },
  { id: 63, name: "UMBC", seed: 15, region: "Midwest" },
  { id: 64, name: "Howard", seed: 16, region: "Midwest" },
];
